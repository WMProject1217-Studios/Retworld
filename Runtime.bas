...
Retval = mciSendString("PLAY BackgroundMusic FROM 0 REPEAT", "", 0, 0)
Playsound = 0
Exit Function
Error:
Playsound = 1145
...
mTotalBytes = 0
mUserBytes = 0
Set ctlNew = GameMainMenu.Controls.Add("VB.drivelistbox", "cmdNew", GameMainMenu)
With ctlNew
    ...
    Next
End With
GameMainMenu.Controls.Remove ctlNew
